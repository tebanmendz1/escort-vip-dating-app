...
export const db = {
  ...
  async createEscort(data) {
    ...
    const newEscort = {
      ...
      age: data.age !== null && data.age !== '' && Number.isFinite(Number(data.age)) ? Number(data.age) : null,
      ...
      hourlyRate: data.hourlyRate !== null && data.hourlyRate !== '' && Number.isFinite(Number(data.hourlyRate)) ? Number(data.hourlyRate) : null,
